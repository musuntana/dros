...
from ..schemas.domain import ProjectMemberRead, ProjectRead
...
class ProjectService(BaseService):
    ...
    def get_project(self, project_id: UUID) -> ProjectDetailResponse:
        ...
        review_summary = Counter(
            review.state.value for review in self.repository.store.reviews.values() if review.project_id == project_id
        )
        active_manuscript = (
